...
| **Solution** | Assign class B the responsibility to create object A if one (or more) of these is true: * B contains or compositely aggregates A * B records A * B closely uses A * B has the initialising data for A |
